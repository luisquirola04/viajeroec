        ...
        <TouchableOpacity activeOpacity={0.85} onPress={onPress} style={{ width, height: 260 }}>
            {isVid ? (
                <View style={{ width, height: 260, backgroundColor: '#111', justifyContent: 'center', alignItems: 'center' }}>
                    {/* Thumbnail del video: si tiene thumbnail úsalo, sino muestra fondo oscuro */}
                    {item.thumbnail ? (
...
const GaleriaModal = ({ 
    ...
    useEffect(() => {
        if (visible) {
            ...
            // Pequeño delay para que el FlatList esté montado
            setTimeout(() => {
    ...
    return (
        ...
        >
            <View style={{ flex: 1, backgroundColor: '#000' }}>
                ...
                {/* Flechas de navegación si hay más de 1 item */}
                {items.length > 1 && (
                    <>
                        {currentIndex > 0 && (
                            <TouchableOpacity 
    ...
    <View style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.headerImageContainer}>
            ...
            {/* Indicador cantidad de multimedia */}
            {multimedia.length > 0 && (
            ...
            {/* Hint "toca para ver" solo en primer render */}
            {multimedia.length > 0 && (
      ...
      {/* ---- MODAL GALERÍA FULLSCREEN CON SWIPE ---- */}
      <GaleriaModal
...
const styles = StyleSheet.create({
  ...
  paginationDotVideo: { borderWidth: 1.5, borderColor: '#f39c12' },
  ...
  routeButton: {
    ...
    paddingVertical: 15, borderRadius: 15, elevation: 4,
  ...
  modalTypeBadge: {
    ...
    backgroundColor: 'rgba(243,156,18,0.8)', flexDirection: 'row', alignItems: 'center',
  ...
  dotVideo: { backgroundColor: '#f39c12' },
