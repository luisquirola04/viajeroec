...
const ImagenConCarga = ({ uri, style }: { uri: string; style: any }) => {
    ...
    return (
        <View style={[style, { justifyContent: 'center', alignItems: 'center', backgroundColor: '#1a1a2e' }]}>
            ...
            />
            {cargando && (
                <ActivityIndicator style={{ position: 'absolute', zIndex: 10 }} size="large" color="#005bea" />
            )}
        </View>
    );
};
        ...
        <View style={{ width: windowWidth, height: windowHeight * 0.75, justifyContent: 'center', alignItems: 'center', backgroundColor: '#000' }}>
            ...
            {cargando && (
                ...
                >
                    ...
                    <Text style={{ color: '#fff', marginTop: 10, fontSize: 13 }}>Cargando video...</Text>
                </View>
            )}
        </View>
    );
    ...
    return (
        ...
        >
            ...
            <View style={{ alignItems: 'center' }}>
                ...
                <Text style={{ color: 'rgba(255,255,255,0.82)', marginTop: 10, fontSize: 14 }}>
                ...
                {isVid ? (
                    esYouTube(item.url) ? (
                        <View style={{ width: windowWidth, height: windowHeight * 0.75, justifyContent: 'center', alignItems: 'center' }}>
                            ...
                            <Text style={{ color: '#fff', fontSize: 16, marginBottom: 20, textAlign: 'center', paddingHorizontal: 20 }}>
                        ...
                        {currentIndex > 0 && (
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    ...
                                    flatListRef.current?.scrollToIndex({ index: ni, animated: true });
                                    setCurrentIndex(ni);
                                }}
                            >
...
export default function LugarDetalleScreen() {
    ...
    const multimedia =
        lugar.Multimedia || lugar.multimedia || lugar.multimedialugars || lugar.multimedias || [];
...
const styles = StyleSheet.create({
    ...
    backButton: {
        ...
        backgroundColor: 'rgba(0,0,0,0.35)', padding: 8, borderRadius: 20,
    },
    mediaCountBadge: {
    ...
    videoLabelBadge: {
        ...
        paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8, zIndex: 5,
    },
    ...
    content: {
        ...
        marginTop: -20, backgroundColor: '#fff', minHeight: 500, elevation: 5,
    },
    ...
    mapContainer: {
        height: 200, width: '100%', borderRadius: 15, overflow: 'hidden',
        marginTop: 10, borderWidth: 1, borderColor: '#ddd',
    },
    map: { width: '100%', height: '100%' },
    routeButton: {
        marginTop: 20, backgroundColor: '#2ecc71', flexDirection: 'row',
        justifyContent: 'center', alignItems: 'center', paddingVertical: 15,
        borderRadius: 15, elevation: 4, shadowColor: '#2ecc71',
    ...
    modalTypeBadge: {
        ...
        backgroundColor: 'rgba(231,76,60,0.8)', flexDirection: 'row', alignItems: 'center',
        paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10, zIndex: 20,
    },
    modalTypeText: { color: '#fff', fontSize: 12, fontWeight: '700', marginLeft: 4 },
    modalDots: {
        position: 'absolute', bottom: 40, left: 0, right: 0,
        flexDirection: 'row', justifyContent: 'center', zIndex: 20,
    },
