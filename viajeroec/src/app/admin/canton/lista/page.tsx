...
export default function ListaCantones() {
  ...
  const obtenerImagenValida = (url: string) => {
    if (!url || !url.startsWith("http")) {
        return "https://images.unsplash.com/photo-1596422846543-75c6a19caa00?q=80&w=1000&auto=format&fit=crop"; 
    }
    return url;
  };
                ...
                {cantones.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 pb-10">
                        {cantones.map((canton: any) => {
                            // Extraemos datos de jerarquía del JSON
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="p-5 flex flex-col flex-1">
                                        ...
                                        <h3 className="text-xl font-bold text-slate-800 mb-3 line-clamp-1" title={canton.nombre}>
                                            {canton.nombre}
                                        </h3>
                                        ...
                                        <div className="mb-4 bg-slate-50 rounded-lg p-3 border border-slate-100 flex flex-col gap-2">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span className="text-xs font-bold text-slate-400 uppercase w-21 flex items-center gap-1">
                                                     País
                                                </span>
